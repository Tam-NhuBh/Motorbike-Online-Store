...
public class searchController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<ProductDetailModel> list = productDetailService.searchByName(txtSearch);
		...
		for (ProductDetailModel o : list) {
			...
			out.println("<div class=\"col-lg-4 col-md-6 col-sm-6 pb-1\">\r\n"
					...
					+ "								<img class=\"img-fluid w-100\" style=\"height: 400px\" src=\"/MotorbikeStore/uploads/images/product/"+o.getPicName()+"\"\r\n"
					+ "									alt=\"\">\r\n"
					...
					+ "								<a class=\"h6 text-decoration-none text-truncate\" href=\"\">"+o.getMotors_Name()+"</a>\r\n"
					+ "								<div\r\n"
