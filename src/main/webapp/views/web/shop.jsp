	...
	<div class="row px-xl-5">
		...
		<div class="col-lg-3 col-md-4">
			...
			<div class="bg-light p-4 mb-30">
				<form>
					<div class="">
						<input type="radio" class="" checked name="radio" id="speed-all" value="0"
							onclick="speedChecked()"> <label class="" for="speed-all">All
							CC</label>
					</div>
					<div class="">
						<input type="radio" class="" id="speed-1" name="radio" onclick="speedChecked1()" value="1">
						<label class="" for="speed-1">50 -110 CC</label>
					</div>
					<div class="">
						<input type="radio" class="" id="speed-2" name="radio" onclick="speedChecked2()" value="2">
						<label class="" for="speed-2">110 -125 CC</label>
					</div>
					<div class="">
						<input type="radio" class="" id="speed-3" name="radio" onclick="speedChecked3()" value="3">
						<label class="" for="speed-3">125 -150 CC</label>
					</div>
			...
			<div class="bg-light p-4 mb-30">
				<form>
					<div class="">
						<input type="radio" class="" checked name="radio" id="branch-all" value="0"
							onclick="branchChecked()"> <label class="" for="branch-all">All
							Brach</label>
					</div>
					<div class="">
						<input type="radio" class="" id="branch-1" name="radio" onclick="branchChecked1()" value="1">
						<label class="" for="branch-1">Honda</label>
					</div>
					<div class="">
						<input type="radio" class="" id="branch-2" name="radio" onclick="branchChecked2()" value="2">
						<label class="" for="branch-2">Yamaha</label>
					</div>
					<div class="">
						<input type="radio" class="" id="branch-3" name="radio" onclick="branchChecked3()" value="3">
						<label class="" for="branch-3">Suzuki</label>
					</div>
					<div class="">
						<input type="radio" class="" id="branch-4" name="radio" onclick="branchChecked4()" value="4">
						<label class="" for="branch-4">SYM</label>
					</div>
						...
						<div class="ml-2">
							...
							<div class="btn-group ml-2">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a class="dropdown-item" href="" onclick="showNum();return false;" >All</a> 
									<a class="dropdown-item" href="" onclick="showNum1();return false;" >5</a> 
									<a
										class="dropdown-item" href="" onclick="showNum2();return false;" >10</a> <a class="dropdown-item"
										href="" onclick="showNum3();return false;" >20</a>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="product-img position-relative overflow-hidden">
									...
									<div class="product-action">
										...
										<a class="btn btn-outline-dark btn-square"
											id="${item.aMotorId}"
											href="addCart?id=${item.aMotorId}&idpage=1"><i
