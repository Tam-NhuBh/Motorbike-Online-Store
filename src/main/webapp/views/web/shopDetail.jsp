		...
		<div class="row px-xl-5">
			...
			<div class="col-lg-7 h-auto mb-30">
				<div class="h-100 bg-light p-30">
					...
					<p class="mb-4">Prepaid Money: ${model.moneyPrepaid}</p>
					...
					<div class="d-flex align-items-center mb-4 pt-2">
						...
						<a class="btn btn-outline-dark btn-square" id="${model.aMotorId}"
							href="addCart?id=${model.aMotorId}&idpage=2"><i
				...
				<div class="bg-light p-30">
					<div class="nav nav-tabs mb-4">
						<a class="nav-item nav-link text-dark active" data-toggle="tab"
							...
							class="nav-item nav-link text-dark" data-toggle="tab"
							href="#tab-pane-3">Reviews (${modelComment2.quantity})</a>
					</div>
					<div class="tab-content">
						...
						<div class="tab-pane fade" id="tab-pane-3">
							<div class="row">
								<div class="col-md-6">
									<h4 class="mb-4">${modelComment2.quantity}reviewfor
						...
						<div class="product-item bg-light mb-4">
							<div class="product-img position-relative overflow-hidden">
								<img class="img-fluid w-100"
									src="/MotorbikeStore/uploads/images/product/${item.picName}" style="height: 400px" alt="">
								<div class="product-action">
									<a class="btn btn-outline-dark btn-square" href="addCart?id=${item.aMotorId}&idpage=2"><i
										class="fa fa-shopping-cart"></i></a> <a
										class="btn btn-outline-dark btn-square" href=""><i
										class="far fa-heart"></i></a>  <a
										class="btn btn-outline-dark btn-square" href="notaddshopDetail?id=${item.aMotorId}"><i
